class GuiBase {
    ...
    */
    ...
    AddLocationText(locationText, ctlName, position := "", width := "") {
        if (!width) {
            width := this.windowSettings["contentWidth"]
        }
        ...
        ;this.SetFont("", "Bold")
        ctl := this.guiObj.AddText("v" . ctlName . " " . position . " w" . width . " h22 +0x200 c" . this.themeObj.GetColor("linkText"), locationText)
        ;this.SetFont()
        return ctl
    }
