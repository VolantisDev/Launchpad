...
class $AssetsGraphicsGen {
  ...
  AssetGenImage get icon => const AssetGenImage('assets/graphics/icon.png');

  $AssetsGraphicsLightGen get light => const $AssetsGraphicsLightGen();

  /// File path: assets/graphics/logo_wide.svg
...
class $AssetsGraphicsLightGen {
  const $AssetsGraphicsLightGen();

  /// File path: assets/graphics/light/logo_wide.svg
  SvgGenImage get logoWide =>
